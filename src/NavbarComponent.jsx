  ...
  return (
    <div className="navbar glass sticky top-0 z-50 md:px-16 lg:px-32">
      <div className="navbar-start">
        ...
        <Link to="/" onClick={handleScrollToTop} className="btn btn-ghost normal-case text-lg flex justify-center items-center gap-2"> TechHelpBD <strong className="text-primary">|</strong>GitDown</Link>
      </div>
